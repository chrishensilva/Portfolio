    ...
    const projectData = {
        ...
        'Ui/Ux Designs': [
            ...
            },
            {
                ...
                prodesc: 'This UI design was crafted for a modern movie streaming platform. The interface features a sleek, dark-themed layout with vibrant highlight colors to reflect the cinematic mood. The homepage includes a dynamic hero banner showcasing featured films, category carousels for genres like action, drama, and sci-fi, and intuitive filtering options.',
                ...
                {projectData[activeCategory].map((item, index) => (
                    ...
                    >
                        <Projects
                            ...
                            cardType={activeCategory === "Graphic Designing" ? "graphic" : "default"}
                        />
                    </motion.div>
                ))}
            </div>
